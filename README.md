...
insert 20000 facts                                                 0.57
export 20000 facts                                                 0.02
import 411160 bytes (20000 facts)                                  0.03
insert 10 facts                                                    0.03
query 10 times w/txn                                               2.28
query 10 times w/o txn                                             0.04
modify 10 attrs w/txn                                              1.93
delete 10 facts w/txn                                              0.88
(and (eq what 'issue-was-closed') (exists... -> 200                1.14
(and (eq what 'issue-was-closed') (exists... -> 200/txn            1.11
(and (eq what 'issue-was-closed') (exists... -> zero               1.14
...
(and (exists foo) (not (exists blue)))                             1.53
(eq id (agg (always) (max id)))                                    2.45
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...                 3.68
(and (eq what "foo") (join "w<=what" (and (eq i...                 6.73
delete!                                                            0.55
(and (eq issue *) (eq repository *) (eq what '*') (eq where '*')) 25.96
Taped.append() x50000                                              0.08
Taped.each() x125                                                  1.57
Taped.delete_if() x375                                             0.76
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-14 at 15:13,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/volodya-lombrozo/factbase/actions/runs/19368817224
