...
import 411148 bytes (20000 facts)                                  0.03
insert 10 facts                                                    0.04
query 10 times w/txn                                               2.42
query 10 times w/o txn                                             0.08
modify 10 attrs w/txn                                              2.01
delete 10 facts w/txn                                              0.95
(and (eq what 'issue-was-closed') (exists... -> 200                1.23
(and (eq what 'issue-was-closed') (exists... -> 200/txn            1.30
(and (eq what 'issue-was-closed') (exists... -> zero               1.28
...
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...                 3.94
(and (eq what "foo") (join "w<=what" (and (eq i...                 7.84
delete!                                                            0.55
(and (eq issue *) (eq repository *) (eq what '*') (eq where '*')) 27.31
...
on 2025-11-22 at 08:42,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/volodya-lombrozo/factbase/actions/runs/19593044669
